...
<html lang="en">
	<head>
		...
		<title>Equation First degree</title>
	...
	<body>
        ...
        <div class="content">
            ...
            <b>L'Equation du second degree s'ecrit comme suit : Ax+B=0</b>
            <form action="first_degree_calcul.php" method="POST" autocomplete="off">
